...
resource "aws_wafregional_rule" "waf_blacklist_rule" {
  ...
  predicate {
    type    = "IPMatch"
    data_id = aws_wafregional_ipset.waf_blacklist_set[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rate_based_rule" "waf_http_flood_rule" {
  ...
  predicate {
    data_id = aws_wafregional_ipset.waf_http_flood_set[0].id
    negated = false
    type    = "IPMatch"
  }
}
...
resource "aws_wafregional_rule" "waf_scans_probes_rule" {
  ...
  predicate {
    type    = "IPMatch"
    data_id = aws_wafregional_ipset.waf_scans_probes_set[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rule" "waf_ip_reputation_lists_rule1" {
  ...
  predicate {
    type    = "IPMatch"
    data_id = aws_wafregional_ipset.waf_reputation_lists_set1[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rule" "waf_ip_reputation_lists_rule2" {
  ...
  predicate {
    type    = "IPMatch"
    data_id = aws_wafregional_ipset.waf_reputation_lists_set2[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rule" "waf_badbod_rule" {
  ...
  predicate {
    type    = "IPMatch"
    data_id = aws_wafregional_ipset.waf_badbot_set[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rule" "waf_sql_injection_rule" {
  ...
  predicate {
    ...
    data_id = aws_wafregional_sql_injection_match_set.waf_sql_injection_detection[0].id
    negated = false
  }
}
...
resource "aws_wafregional_rule" "waf_xss_rule" {
  ...
  predicate {
    type    = "XssMatch"
    data_id = aws_wafregional_xss_match_set.waf_xss_dectection[0].id
    negated = false
  }
}
